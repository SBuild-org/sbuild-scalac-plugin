...
class SBuild(implicit _project: Project) {
  ...
  val namespace = "org.sbuild.plugins.scalac"
  val version = "0.0.9000"
  val url = "https://github.com/SBuild-org/sbuild-scalac-plugin"
  ...
  Plugin[SBuildPlugin] configure (_.copy(
    ...
    pluginClass = s"${namespace}.Scalac",
  ...
  Plugin[MavenDeploy] configure (_.copy(
    ...
    version = version,
    artifactName = Some("SBuild Scalac Plugin"),
    description = Some("An SBuild Plugin that provides Scalac compiler support."),
